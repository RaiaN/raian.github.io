...
**What awaits us in near future?**

- Integrate [libva](https://github.com/intel/libva). Sadly, Windows setup is tricky but I hope they improve it at some point!

- Buy x264 non-GPL license :)

- Implement your own video encoding solution :))
