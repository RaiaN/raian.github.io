...
[Runtime Video Recorder](https://unrealsolutions.com) matured extremely well. Many public companies are now using it including Amazon Games and Meta. Even more SMEs successfully leveraged it. Finally, RVR now also supports includes Mac, iOS and tvOS (via AVFoundation) as well as Linux (both video and audio). Check Documentation if you want to integrate RVR into your Unreal app [click here](https://unrealsolutions.com/docs/)


**Update**

Thank you for reading this blog post! I appreciate your support and interest for Runtime Video Recorder. A lot of things have changed since it went live. In particular, it nows has a full support for hardware accelerated encoding on Oculus/PCVR and Android phones via *MediaCodec* (yes!).
