...
Runtime Video Recorder matured extremely well. Many public companies are now using it including Amazon Games and Meta. Even more small to medium businesses integrated it. Finally, platform support now includes Mac, iOS and tvOS (via AVFoundation) as well as Linux (both video and audio). Documentation is a must if you need to integrate RVR into your Unreal app [click here](https://unrealsolutions.com/docs/


**Update**

Thank you for reading this blog post! I appreciate your support and interest for Runtime Video Recorder. A lot of things have changed since it went live. In particular, it nows has a full support for hardware accelerated encoding on Oculus/PCVR and Android phones via MediaCodec. New licensing [terms](https://unrealsolutions.com).
